    ...
    <footer className="bg-gray-900 text-white py-10 px-20 animate__animated animate__fadeInUp">
      <div className="container mx-auto flex flex-col md:flex-row justify-between px-4">
        ...
        <div className="mb-8 md:mb-0">
         ...
         <p className='mb-3 font-bold text-2xl'> Arohi Software</p>
          <div className="flex gap-4">
            ...
            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.342 3.608 1.317.975.975 1.255 2.242 1.317 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.342 2.633-1.317 3.608-.975.975-2.242 1.255-3.608 1.317-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.342-3.608-1.317-.975-.975-1.255-2.242-1.317-3.608-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.062-1.366.342-2.633 1.317-3.608.975-.975 2.242-1.255 3.608-1.317 1.266-.058 1.646-.07 4.85-.07m0-2.163c-3.259 0-3.667.014-4.947.072-1.585.071-2.994.348-4.086 1.439-1.092 1.092-1.368 2.501-1.439 4.086-.058 1.28-.072 1.688-.072 4.947s.014 3.667.072 4.947c.071 1.585.348 2.994 1.439 4.086 1.092 1.092 2.501 1.368 4.086 1.439 1.28.058 1.688.072 4.947.072s3.667-.014 4.947-.072c1.585-.071 2.994-.348 4.086-1.439 1.092-1.092 1.368-2.501 1.439-4.086.058-1.28.072-1.688.072-4.947s-.014-3.667-.072-4.947c-.071-1.585-.348-2.994-1.439-4.086-1.092-1.092-2.501-1.368-4.086-1.439-1.28-.058-1.688-.072-4.947-.072z"/>
        ...
        <div>
          ...
          <p className="mb-2">Near Sai Hospital Building bhairavnath chowk shrigoanda </p>
          <p className="mb-2">Email: arohisoftware98@gmail.com</p>
          <p>Phone: +91 7517861332</p>
        </div>
      </div>
